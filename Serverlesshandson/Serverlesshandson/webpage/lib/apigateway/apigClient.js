...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://pqjbzu9esl.execute-api.us-east-1.amazonaws.com/demo';
    ...
    apigClient.itemsGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['artist'], ['body']);
        
        var itemsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/items').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['artist']),
            body: body
        };
